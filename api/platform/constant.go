...
import "github.com/leokwsw/go-chatgpt-api/api"
...
const (
	...
	apiCreateAudioTranscriptions = api.PlatformApiUrlPrefix + "/v1/audio/transcriptions"
	apiCreateAudioSpeech         = api.PlatformApiUrlPrefix + "/v1/audio/speech"
